...
class Student:
  def __init__(self,root):
    ...
    dep_combo["value"]=("Select Department","CSE","CSEAI","IT","ECE","CHE")
    dep_combo.current(0)
    ...
    year_combo["value"]=("Select Year","2k21-22","2k22-23","2k23-24","2k24-25")
  ...
  def update_data(self):
    if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
      ...
      try:
        Update=messagebox.askyesno("Updata","Do you want to update this student details",parent=self.root)
        if Update>0:
          conn=mysql.connector.connect(host="localhost",username="root",password="9936",database="face_recognizer")
          my_cursor=conn.cursor()
